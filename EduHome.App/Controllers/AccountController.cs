...
namespace EduHome.App.Controllers
{
    public class AccountController : Controller
    {
        ...
        private readonly x.IMailService _mailService;

        public AccountController(RoleManager<IdentityRole> roleManager, UserManager<AppUser> userManager, SignInManager<AppUser> signinManager, IWebHostEnvironment env, x.IMailService mailService)
        {
        ...
        public async Task<IActionResult> Register(RegisterViewModel registerView)
        {
            ...
            await _mailService.Send("isans@code.edu.az", appUser.Email, link, text, "Verify Email");

            TempData["Register"] = "Verify your Email!";
